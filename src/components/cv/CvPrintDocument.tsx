...
export const CvPrintDocument: React.FC<CvPrintDocumentProps> = ({ mode: propMode }) => {
  ...
  return (
    ...
    >
      {/* Framed Card with Subtle Border and Rounded Corners */}
      <div
        className={`cv-card rounded-2xl bg-white overflow-hidden ${
          isDigital
            ? 'border-2 border-[rgba(0,210,235,0.45)] shadow-2xl'
            : 'border border-[rgba(0,139,163,0.32)] shadow-none'
        }`}
      >
        ...
        <div className="relative bg-[#03141a] h-16 w-full px-6 flex items-center overflow-visible">
          {/* Avatar Circle - Straddles the boundary between dark banner and white title bar */}
